...
/**functions to perform numerical conversions*/
public class Transformer
{
    ...
    /**Decimal number to Binary number conversion in an array*/
    ...
    /**Function to convert Hex number to Decimal number conversion in an array*/
